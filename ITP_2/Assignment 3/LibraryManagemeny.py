...
class Library:
    ...
    def apply_discounts(self, discount_percentage):
        for book in self.books:
        ...
        if choice == "1":
            ...
            while True:
                if is_ebook == "yes":
                    ...
                    library.add_book(EBook(book_id, title, price, file_size))
                    break
                elif is_ebook == "no":
                    library.add_book(Book(book_id, title, price))
                    break
                else:
            ...
            library.apply_discounts(discount)
